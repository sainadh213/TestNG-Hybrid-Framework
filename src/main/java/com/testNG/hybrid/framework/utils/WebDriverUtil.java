package com.testNG.hybrid.framework.utils;
...
import com.testNG.hybrid.framework.base.BaseTest;
...
public class WebDriverUtil {
	...
	public void enterText(WebElement element, String text) {
		wait = new WebDriverWait(BaseTest.driver, Duration.ofSeconds(20));
	...
	public void waitForAnElementLocated(WebElement element, int time) {
		wait = new WebDriverWait(BaseTest.driver, Duration.ofSeconds(time));
	...
	public void mouseOver(WebElement element) {
		actions = new Actions(BaseTest.driver);
	...
	public String getChildWindow(String parentWindow) {
	    for (String win : BaseTest.driver.getWindowHandles()) {
